    ...
    methods: {
        ...
        initChart() {
            ...
            var y = d3.scaleLinear()
                .domain([0, y_max])
                // .domain([40, 0])
                .range([ parentRect.height - this.margin.bottom, this.margin.top + 40]);
            ...
            const bars = svg.selectAll("rect")
                ...
                .attr("transform", `translate(${this.margin.left + this.margin.right+ 40}, ${this.margin.bottom - parentRect.height/25})`)
                ;
            ...
            // Add X axis
            svg.append("g")
                .attr("transform", `translate(${this.margin.left + this.margin.right+ parentRect.width/15}, ${parentRect.height - parentRect.height/25})`)
                .call(d3.axisBottom(x).tickSize(0));
            
            // X axis label
            svg.append("text")
                .attr("class", "x label")
                .attr('transform', `translate(${parentRect.width / 1.75}, ${parentRect.height + 15})`)
            ...
            // Add Y axis
            svg.append("g")
                .attr('transform', `translate(${this.margin.left + this.margin.right + parentRect.width/15}, ${this.margin.bottom - parentRect.height/25})`)
                .call(d3.axisLeft(y)
            ...
            // Add Y axis label
            svg.append('g')
                .attr('transform', `translate(${this.margin.left + this.margin.right}, ${this.size.height / 2 + this.margin.top}) rotate(-90)`)
                .append('text')
                .attr("text-anchor", "middle")
                .style('font-size', '12px')
            ...
            svg.append('g').append('text') // adding the text
                .attr('transform', `translate(${parentRect.width / 1.75}, ${this.margin.top + this.margin.bottom})`)
