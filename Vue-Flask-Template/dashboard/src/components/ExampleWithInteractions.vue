...
export default {
    ...
    methods: {
        ...
        initChart() {
            let chartContainer = d3.selectAll('#scatter-svg-interactions')
        ...
        initLegend() {
            let legendContainer = d3.selectAll('#scatter-legend-svg')
        ...
        rerender() {
            d3.selectAll('#scatter-svg-interactions').selectAll('*').remove() // Clean all the elements in the chart
            d3.selectAll('#scatter-legend-svg').selectAll('*').remove()
            this.initChart()
            this.initLegend()
        }
    },
